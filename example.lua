...
local Window = Rayfield:CreateWindow({
	...
	ConfigurationSaving = {
		Enabled = true,
		FolderName = "RayfieldGen3Example",
		FileName = "Example",
	},
})
...
Home:CreateFAQ({
	Items = {
		{
			Question = "Why was this Gen 3 concept created?",
			Answer = "So people can experience a Gen 3 style Rayfield right now instead of waiting for the official release. It is a concept project built from zero, not a replacement for the real thing.",
		},
		{
			Question = "Will my existing Rayfield scripts work?",
			Answer = "Yes. Gen 3 keeps the original Rayfield API, so most scripts load without any changes. Swap the loadstring URL and your window, tabs and elements come up in the new look.",
		},
		{
		...
		},
		{
			...
			Answer = "There is no formal bug tracker or update roadmap. This is a concept build whose only goal is to let people experience Gen 3 before the official release, so ongoing updates are not planned. If you still want to share a problem or an idea, the Discord server is the place: https://discord.gg/hXtTC9SVfX",
		},
		{
